    ...
    "experienceEducation": {
      ...
      "dataExp": {
        ...
        "items": [
          ...
          {
            "nameBusiness": "SENA",
            "Description": "Desarrollé un sistema de control de acceso para un centro usando C# en Windows Form, una API con ASP.NET y una base de datos SQL Server. Además, me preparé para una competencia utilizando C# para desarrollo de escritorio y Java para desarrollo de aplicaciones móviles.",
            "Rol": "Competidor - Desarrollador",
            "StartDate": "01/06/2021",
            "EndDate": "30/11/2021",
            "tools": ["C#", "HTML", "CSS", "Javascript", "SQL Server", "Android Studio", "Java"]
          },
          {
            "nameBusiness": "SENA",
            "Description": "Me preparé para la competencia de WorldSkills utilizando los siguientes lenguajes de programación: C# para el desarrollo de páginas web, aplicaciones de escritorio y API, con el uso del framework Entities Framework. Realice pruebas automatizadas con UNIT en C#, utilice Kotlin para crear aplicaciones móviles y JavaScript con el Framework de Vue.js para el desarrollo de páginas web.",
            "Rol": "Competidor - Desarrollador",
            "StartDate": "01/02/2022",
            "EndDate": "30/12/2022",
            "tools": ["C#", "HTML", "CSS", "Javascript", "SQL Server", "Android Studio", "Kotlin"]
          },
          {
            "nameBusiness": "Monnerverse",
            "Description": "Se creó una página web interactiva utilizando el Framework de Vue.js y JavaScript. La página cuenta con animaciones suaves y un estilo dinámico similar al de una presentación de PowerPoint, sin requerir desplazamiento vertical para navegar por el contenido.",
            "Rol": "Desarrollador Web Fronted",
            "StartDate": "01/10/2022",
            "EndDate": "30/12/2022",
            "tools": ["Vue.js", "HTML", "CSS", "Javascript", "SEO"]
          },
          {
            "nameBusiness": "Vittoria Pizzeria",
            "Description": "Desarrollé una aplicación para un restaurante de comida rápida, especializado en pizza, utilizando Angular, TypeScript y SCSS. La aplicación permite a los clientes hacer pedidos en línea y personalizar sus pizzas según sus gustos y preferencias",
            "Rol": "Desarrollador Web Fronted",
            "StartDate": "01/12/2022",
            "EndDate": "01/02/2023",
            "tools": ["Angular", "HTML", "CSS", "TypeScript", "SEO"]
          },
          {
            "nameBusiness": "Mi portafolio",
            "Description": "Desarrollé un portafolio para mostrar mis habilidades y más información sobre mi, utilizando Angular, TypeScript y SCSS. ",
            "Rol": "Desarrollador Web Fronted",
            "StartDate": "01/12/2022",
            "EndDate": "01/02/2023",
            "tools": ["Angular", "HTML", "CSS", "TypeScript", "SEO"]
      ...
      "dataEdu": {
        ...
        "items": [
          ...
          {
            "nameBusiness": "Secundaria",
            "Description": "Estudio en la secundaria en la Junta hasta decimo grado, siempre ocupe el primero puesto entre mis compañeros y resalte con grendes honores en el colegio, queria terminar pero tuvimos que mundarnos y irme de mi pueblo querido.",
            "Rol": "Competidor - Desarrollador",
          ...
          {
            "nameBusiness": "Secundaria",
            "Description": "Me gradue en el colegio Pablo VI, en Colombia, La Guajira, Barrancas, ocupe el 3 puesto del colegio en las pruebas ICFES",
            "Rol": "Pablo",
